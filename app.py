...
<div class="main-header">
    ...
    <p>Tác giả: Ma Thị Diện - Trường Tiểu học Minh Quang - ĐT: 0964243473</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Thị Diện - Trường Tiểu học Minh Quang - ĐT: 0964243473</div>", unsafe_allow_html=True)
